...
const DeleteIcon = ({ fill = 'var(--purple_800)', width = 24, height = 24 }: IconProps) => {
  return (
    <svg width={width} height={height} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
      <g data-name="Layer 17" id="Layer_17">
        ...
        />
        <path fill={fill} d="M16,26a1,1,0,0,1-1-1V11a1,1,0,0,1,2,0V25A1,1,0,0,1,16,26Z" />
        <path fill={fill} d="M21,24a1,1,0,0,1-1-1V13a1,1,0,0,1,2,0V23A1,1,0,0,1,21,24Z" />
        <path fill={fill} d="M11,24a1,1,0,0,1-1-1V13a1,1,0,0,1,2,0V23A1,1,0,0,1,11,24Z" />
      </g>
    </svg>
  );
};
